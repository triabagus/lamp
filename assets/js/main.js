...
const scrollUp = () =>{
    ...
    // When the scroll is higher than 350 viewport height, add class show-scroll
...
// We valdiate if the user previously chose a topic
if(selectedTheme){
    // If the validation is fulfilled, we ask what the issues was to know if we activated
...
themeButton.addEventListener('click', () =>{
    ...
    // We save the theme and the current icon that the user change
